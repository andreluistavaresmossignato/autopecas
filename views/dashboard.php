...
<body>
    <div class="container">
        ...
        <div class="dashboard-menu">
            ...
            <a href="../controllers/ProdutoController.php?acao=estatisticas" class="menu-card" style="background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%);">
                <div class="icon"><i class="bi bi-graph-up-arrow"></i></div>
                <h3>Estatísticas</h3>
                <p>Gráficos, valor do estoque e alertas de reposição</p>
            </a>
